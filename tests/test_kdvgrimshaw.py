...
from iwaves.utils.density import lamb_tanh_rho
...
# Load the parameters
strat_param_file = '~/Share/ARCHub/MODELLING/SolitonNWS/DATA/bestfit_rho_params.csv'
...
#    """
#
#    def __init__(self, rhoz, z, h, x, wavefunc=isw.sine, **kwargs):
#	
#	Nz = z.shape[0]
#	Nx = x.shape[0]
